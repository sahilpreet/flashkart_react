...
function SearchPage(props) {
    const [urlparams, seturlparams] = useState(`${absolute_url}/api/search/${props.location.search.replace("?", "")}`)
    ...
    useEffect(() => {
        seturlparams((prevState)=>`${absolute_url}/api/search/${props.location.search.replace("?", "")}`)
