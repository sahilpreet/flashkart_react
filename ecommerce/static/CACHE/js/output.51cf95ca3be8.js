...
params={method:"post",credentials:'same-origin',credentials:'include',body:JSON.stringify(bodyData),headers:{'X-CSRFToken':"sdx8C571FKCWHKDMmOqdDjzNL2eEB7oFTdvvUs0FrU4zE8qTEIbPFqCVxgX3hqE0",'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','Accept':'application/json','X-Requested-With':'XMLHttpRequest'},}
...
if("AnonymousUser"=='AnonymousUser'){window.location.href="/register";console.log("redirect")
return;}
