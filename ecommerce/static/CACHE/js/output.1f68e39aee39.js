...
params={method:"post",credentials:'same-origin',credentials:'include',body:JSON.stringify(bodyData),headers:{'X-CSRFToken':"Iko1wYt5VQ6WN0KDIHqyFkuDDLUeWH3w9kmoOlmJH0yzKoxK0BbaHrxLpZDDC0jR",'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8','Accept':'application/json','X-Requested-With':'XMLHttpRequest'},}
